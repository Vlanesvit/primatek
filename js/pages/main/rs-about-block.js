...
==================================== */
const tabAboutBlock = () => {
	const contactBlock = document.querySelectorAll('.rs-about-block');
...
if (document.querySelector('.rs-about-block [data-tabs-handler]') && document.querySelector('.rs-about-block [data-tabs-field]')) {
	tabAboutBlock()
}